...
})({"dDK16":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4223c602b1830c12";
...
},{}],"6QhtI":[function(require,module,exports) {
...
const Place = ()=>{
    ...
    const Place1 = (id, t, l, w, h)=>{
        document.querySelector("#" + id).style.cssText = "top: " + t + "px;" + "left: " + l + "px;" + "width: " + w + "px;" + "height: " + h + "px;";
    };
    // const config = [
...
},{"./styles.css":"i9uEN"}],"i9uEN":[function(require,module,exports) {
...
},{}]},["dDK16","6QhtI"], "6QhtI", "parcelRequire94c2")

//# sourceMappingURL=index.b1830c12.js.map
