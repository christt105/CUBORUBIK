...
})({"4tjbQ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a1c086442044f0ed";
...
},{}],"2Fvtt":[function(require,module,exports) {
// import './styles.css'
...
const Place1 = ()=>{
    ...
    if (widthId / 4 < heightId / 9) [widthId, heightId] = [
        widthId / 4,
        widthId / 4
    ];
    else [widthId, heightId] = [
        heightId / 9,
        heightId / 9
    ];
    console.log(widthId, heightId);
    let element = document.querySelector("#back");
    element.style.cssText = "top: 0px;left: " + widthId + "px;" + "width: " + widthId + "px;" + "height: " + heightId + "px;";
    element = document.querySelector("#left");
    element.style.cssText = "top: " + heightId + "px;" + "left: " + 0 + "px;" + "width: " + widthId + "px;" + "height: " + heightId + "px;";
    element = document.querySelector("#bottom");
    element.style.cssText = "top: " + heightId + "px;" + "left: " + widthId + "px;" + "width: " + widthId + "px;" + "height: " + heightId + "px;";
    element = document.querySelector("#right");
    element.style.cssText = "top: " + heightId + "px;" + "left: " + 2 * widthId + "px;" + "width: " + widthId + "px;" + "height: " + heightId + "px;";
    element = document.querySelector("#top");
    element.style.cssText = "top: " + heightId + "px;" + "left: " + 3 * widthId + "px;" + "width: " + widthId + "px;" + "height: " + heightId + "px;";
    element = document.querySelector("#front");
    element.style.cssText = "top: " + 2 * heightId + "px;" + "left: " + widthId + "px;" + "width: " + widthId + "px;" + "height: " + heightId + "px;";
    element = document.querySelector("#all");
    element.style.cssText = "top: " + 3 * heightId + "px;" + "left: " + 0 + "px;" + "width: " + window.innerWidth + "px;" + "height: " + (window.innerHeight - 3 * heightId) + "px;";
};
Place1();
window.addEventListener("resize", Place1);

},{}]},["4tjbQ","2Fvtt"], "2Fvtt", "parcelRequire94c2")

//# sourceMappingURL=index.2044f0ed.js.map
